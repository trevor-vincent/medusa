...
int main(int argc, char **argv) {
  ...
  ptensor A = mptensor::tensordot(mpo[0],Atrans, mptensor::Axes(1), mptensor::Axes(0));
  A = mptensor::contract(A, mptensor::Axes(0), mptensor::Axes(1));

  ptensor Btrans = mptensor::transpose(mpo[0], mptensor::Index(1,0,2,3));
